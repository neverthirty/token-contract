...
{ ."Error: incorrect message body" cr
  ...
  ."Got      " msg.body <s csr.
0 halt } if
${makeExtDest(outMsg.to)} shash msg.dest shash B= not { ."Error: incorrect message destination" cr msg.dest .s 0 halt } if
...
{ ."Error: incorrect message body" cr 
  ...
  ."Got      " msg.body <s csr.
0 halt } if
${outMsg.to ? `"${outMsg.to}" parse-smc-addr drop msg.dest 2<> { ."Error: incorrect message destination" cr msg.dest .s 0 halt } if` : ""}
